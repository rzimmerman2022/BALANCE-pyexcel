...
def main():
    ...
    print("\n📋 WHAT THIS INCLUDES:")
    print("  ✅ Rent payments (Jordyn pays full, Ryan owes 43%)")
    print("  ✅ All shared expenses split appropriately")
    print("  ✅ All Zelle transfers between you")
    print("  ✅ Personal expenses (each pays for their own)")
