# BALANCE Project - Simple Analysis Pipeline
# This script runs the analysis pipeline for Power BI and reporting
...
Write-Host "🏦 BALANCE Project - Analysis Pipeline" -ForegroundColor Cyan
...
Write-Host "  .\Run-Analysis.ps1 -QuickRun      # Power BI + Dashboard only" -ForegroundColor Gray
Write-Host "  .\Run-Analysis.ps1 -PowerBIOnly   # Power BI datasets only" -ForegroundColor Gray
Write-Host "  .\Run-Analysis.ps1 -FullAnalysis  # Complete analysis pipeline" -ForegroundColor Gray
