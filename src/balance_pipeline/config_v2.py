###############################################################################
# BALANCE-pyexcel – Pipeline Configuration v2
#
# Description : Dataclass-based configuration for the unified pipeline.
# Key Concepts: - Environment variable overrides
#               - Path resolution and validation
#               - Logging level control
# Public API  : - PipelineConfig dataclass
#               - pipeline_config_v2 (global instance)
# -----------------------------------------------------------------------------
# Change Log
